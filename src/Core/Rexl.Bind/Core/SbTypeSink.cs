...
/// <summary>
/// A convenient <see cref="TypeSink"/> wrapper of a <see cref="StringBuilder"/>.
/// </summary>
public partial class SbTypeSink : TypeSink
{
    ...
    public SbTypeSink(StringBuilder? sb = null)
        : base()
    {
    ...
    /// </summary>
    public SbTypeSink SetOut(StringBuilder sb, out StringBuilder prev)
    {
