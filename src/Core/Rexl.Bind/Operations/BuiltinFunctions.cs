...
public class BuiltinFunctions : OperationRegistry
{
    ...
    private BuiltinFunctions()
    {
        ...
        AddOne(TextPadFunc.Left, new Sig(S.AboutPadLeft, A.Create(S.ArgSource, S.AboutPad_Source), A.Create(S.ArgSource, S.AboutPad_Len)));
        AddOne(TextPadFunc.Right, new Sig(S.AboutPadRight, A.Create(S.ArgSource, S.AboutPad_Source), A.Create(S.ArgSource, S.AboutPad_Len)));
